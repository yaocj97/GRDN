...
if __name__ == "__main__":
    ...
    plot_model(model,to_file='CNN-2.png')
    #modify
    checkpoint = ModelCheckpoint('CNN-2.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='min')
    tb_callback = TensorBoard(log_dir='./CNN-2',histogram_freq=0,write_images=False, write_graph=True)
